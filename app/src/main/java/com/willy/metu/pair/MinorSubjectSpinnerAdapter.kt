...
class MinorSubjectSpinnerAdapter (private val strings: Array<String>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if(position == 0){
            binding.user = MeTuApplication.instance.resources.getString(R.string.spinner_select_subject)
